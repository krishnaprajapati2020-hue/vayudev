// Calibrated gaze tracking frame mapping
// Each tuple is [angleInRadians, videoTimeInSeconds]
export const GAZE_FRAMES: [number, number][] = [
  [0.037186, 2.54167],
  [0.130722, 2.58333],
  [0.234912, 2.625],
  [0.321399, 2.66667],
...
export function timeForAngle(angle: number): number {
